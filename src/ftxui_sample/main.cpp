...
// configuration step. It creates a namespace called `template_testing`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", template_testing::cmake::project_name, template_testing::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", template_testing::cmake::project_version);
      return EXIT_SUCCESS;
    }
